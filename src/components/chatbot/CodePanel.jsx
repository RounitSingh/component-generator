...
// Import some popular dark themes
...
const CodePanel = memo(({ code }) => {
  ...
  return (
    <div className="h-full overflow-auto p-6 bg-slate-900 text-slate-100">
      <div className="flex gap-3 mb-6">
        <button
          className="flex items-center gap-2 px-4 py-2.5 cursor-pointer bg-slate-800 hover:bg-slate-700 text-slate-200 rounded-xl font-medium transition-all duration-200 disabled:opacity-50"
          onClick={() => copyToClipboard(code.jsx)}
          disabled={!code.jsx}
          title="Copy JSX/TSX"
        >
      ...
      <div className="space-y-6">
        <div>
          ...
          <div className="rounded-2xl overflow-hidden border border-slate-700 shadow-sm">
            <Suspense
              fallback={
            ...
            >
              <SyntaxHighlighter
                language="jsx"
                style={oneDark} // 🎨 dark theme applied
                customStyle={{
                  margin: 0,
                  borderRadius: 0,
                  fontSize: '14px',
